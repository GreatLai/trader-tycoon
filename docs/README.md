...
当前正式版本为 **v1.17.0**，现行玩法包括首日一涨一跌的开局突发行情、五个默认职业、每局 3 次的通商令、六个固定经营费账期、开市资金结算、两档库存清算、20 种特质商品、6 种常规上架商品、7 种生态行情上架商品、10 组完整生态事件，以及基于真实交易利润的局内成就反馈。道具卡与奇货铺已退出现行玩法。
