...
- 三个职业默认开放：“无用之人”保持标准规则；“牙商”以低价行情和风险抬价寻找利润；“行商”可通过熟路与赶集让库存重新上架，但赶集货物当天成交需支付 5% 路费。
...
职业扩展采用独立规则上下文：单局保存职业 ID、技能冷却和职业运行数据，各职业成绩保存在独立生涯档案中。“无用之人”保持标准市场规则；“牙商”改变普通价格区间并承担抬价失败风险；“行商”改变库存重返货架的机会，并通过赶集路费换取即时出货窗口。
