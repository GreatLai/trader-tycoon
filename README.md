...
- 经营费分六个 15 天账期固定收取，90 天合计 147.375 万元；仓储费按库存收取，开市弹窗会列明费用、清算与资产变化。
- 现金不足时优先按当日市价清算已上架库存；仍不足时，未上架库存按实际购入均价的 20% 处理，禁售状态不可绕过。
- 财富评级提升后自动扩大仓库；历史最高资产达到千万后永久解锁高价值商品。
- 五个职业默认开放：“无用之人”保持标准规则；“牙商”以低价行情和风险抬价寻找利润；“行商”通过熟路与赶集重获出货窗口；“投机商”追逐自然突发事件；“盐铁专营”只能经营四种指定商品，将全部行情偏离放大 3 倍，并以风向标召来相关生态事件。
...
职业扩展采用独立规则上下文：单局保存职业 ID、技能冷却和职业运行数据，各职业成绩保存在独立生涯档案中。“无用之人”保持标准市场规则；“牙商”改变普通价格区间并承担抬价失败风险；“行商”以赶集路费换取库存重新报价；“投机商”放大自然事件，并可安排次日方向不确定的后续报道；“盐铁专营”通过逐商品规则限制交易范围、放大普通与事件行情，并从现有生态事件池召唤相关事件。
